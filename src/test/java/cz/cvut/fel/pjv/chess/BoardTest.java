...
public class BoardTest {
    ...
    public void testGetValidMoves_Castling() {
        ...
        board.placeFigure(oppRook1, new Field(3, 3));

        Rook oppRook2 = new Rook(MyColor.BLACK, board);
        board.placeFigure(oppRook2, new Field(3, 6));
   ...
   row  3 - - - r - - r -
    ...
    public void testGetValidMoves_Figure() {
        ...
        board.placeFigure(myBishop, new Field(4, 3));
   ...
   row  3 - - o - - - - -
    ...
    public void testIsInCheck_WhiteKing2() {
        ...
        board.placeFigure(myRook, new Field(4, 3));
